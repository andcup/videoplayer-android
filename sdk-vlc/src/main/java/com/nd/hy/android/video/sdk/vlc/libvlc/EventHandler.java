...
public class EventHandler {
    ...
    public static final int MediaPlayerSecondBuffering        = 0x113;
    public static final int MediaPlayerCacheRate              = 0x114;
    ...
    public static final int MediaPlayerResize                 = 0x4000;
    public static final int MediaPlayerNetworkLower           = 0x4001;
    public static final int MediaPlayerPlayTimeChanged        = 0x4002;
    public static final int MediaPlayerPlayPrepare            = 0x6001;
